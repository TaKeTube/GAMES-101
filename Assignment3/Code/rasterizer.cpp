...
void rst::rasterizer::draw(std::vector<Triangle *> &TriangleList) {
    ...
    for (const auto& t:TriangleList)
    {
        ...
        // from mm.begin to mm.end
        // take every element e
        // get e.head<3>()
        // put it into the position begin at viewspace_pos.begin()
        ...
        // WHY inv_trans?
        // Because after transformation, the normal vector would not be perpendicular to the surface
