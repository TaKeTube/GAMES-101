                                ...
                                const std::array<int, 3>& dirIsNeg) const
{
    ...
    double tMaxxy = tMinx>tMiny?tMinx:tMiny;
    double tEnter = tMaxxy>tMinz?tMaxxy:tMinz;
    double tMinxy = tMaxx<tMaxy?tMaxx:tMaxy;
    double tExit = tMinxy<tMaxz?tMinxy:tMaxz;
